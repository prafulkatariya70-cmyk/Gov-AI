...
class NotificationParser:
    ...
    def _parse_application_start(
        ...
        patterns = [
            (
                r"(?:online\s+)?application(?:\s+window)?\s*"
                r"(?:opens?|starts?|commences?)\s*(?:on|from)?\s*"
                r"(\d{1,2}(?:[./-]\d{1,2}[./-]\d{2,4}|\s+(?:January|February|March|April|May|June|July|August|September|October|November|December|Jan|Feb|Mar|Apr|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec)\s+\d{2,4}))"
            ),
            (
    ...
    def _parse_application_end(
        ...
        patterns = [
            ...
            (
                r"(?:last\s+date\s+to\s+apply|last\s+date\s+for\s+online\s+application|closing\s+date)\s*[:\-]?\s*"
                r"(\d{1,2}\s+(?:January|February|March|April|May|June|July|August|September|October|November|December|Jan|Feb|Mar|Apr|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec)\s+\d{2,4})"
            ),
            (
